...
export class UserController {
  ...
  @Post('register')
  public async register(@Body() body: UserParams): Promise<any> {
  ...
  @Post('login')
  @HttpCode(200)
  public async login(@Body() body: UserParams): Promise<any> {
    const user: any = await this.model.instance.findOne({
